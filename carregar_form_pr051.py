...
with app.app_context():
    ...
    for r in linhas:
        ...
        # Resolve a NF contra a view. Sem correspondência, a conferência seria
        # órfã: como homepage e gráficos usam INNER JOIN com a view, ela nunca
        # apareceria em tela nenhuma. Melhor não inserir — o login runtime não
        # tem DELETE para desfazer.
    ...
    for pedido, item, antes, depois in nf_corrigidas:
    ...
    for pedido, item, nf_planilha, disponiveis in sorted(orfaos):
